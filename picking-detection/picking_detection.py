...
class HumanMachineSafety:
    ...
    def draw_palm_detection(self, palm_coords, depth):
        ...
        for bbox in palm_coords:
            ...
            if math.isnan(x) or math.isnan(x) or math.isnan(x):
                return None
...
model_nn.setBlobPath(str(Path("models/palm_detection.blob").resolve().absolute()))
...
sdn.setBlobPath("models/mobilenet_ssd.blob")
