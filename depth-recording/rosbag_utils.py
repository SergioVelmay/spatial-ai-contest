...
class DepthAiBags:
    ...
    def __init__(self, path: Path, device, resolutions, rgb=False, overwrite = False):
        ...
        register_types(get_types_from_msg((Path(self.dir) / 'messages' / 'CameraInfo.msg').read_text(), 'sensor_msgs/msg/CamInfo'))
        ...
        self.write_keyvalues('/device_0/sensor_0/property', {'Depth Units': '0.001000'})
        ...
        if rgb:
            ...
            self.write_keyvalues('/device_0/sensor_1/property', {'Backlight Compensation': '0.000000'})
    ...
    def write_streamInfo(self, depth = False, rgb = False):
        register_types(get_types_from_msg((Path(self.dir) / 'messages' / 'StreamInfo.msg').read_text(), 'realsense_msgs/msg/StreamInfo'))
